...
//     // Allocate buffer for command parameters
...
//     if (err) {
//         printk("Read TX power level failed (err %d)\n", err);
//         return;
//     }
...
//     int err = bt_hci_cmd_send_sync(BT_HCI_OP_VS_READ_TX_POWER_LEVEL,
